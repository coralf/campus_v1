...
<body>
					...
					<div class="panel loginbox">
						...
						<div class="panel-body"
							...
							<div class="form-group">
								<div class="field field-icon-right">
									<input type="text" id="name" class="input input-big" name="name"
							...
							<div class="form-group">
								<div class="field">
									<input type="text" class="input input-big" id="codetext" name="codetext"
										placeholder="填写右侧的验证码" data-validate="required:请填写右侧的验证码" />
									<img id="checkCode"
										src="${pageContext.request.contextPath }/AdminServlet?method=checkCode"
										alt="" width="100" height="32" class="passcode"
										style="height:43px;cursor:pointer;" onclick="refresh()">
								</div>
							</div>
						</div>
						<div style="padding:30px;">
							<input type="button"
								...
								value="登录">
							<span id="useric" class="text-red"></span>
						</div>
					</div>
				</form>
			</div>
	...
	<script type="text/javascript">
			...
			$("#infoSub").click(function(){
				...
				$.post("${pageContext.request.contextPath }/AdminServlet?method=login",
				  {
				    "username":username,
				    "password":password,
				    "codetext":codetext
					  ...
					  function(data,status){
					    if(data==1){
					    	location.href="${pageContext.request.contextPath }/Admin/private/index.jsp";
					    }else{
					    	$("#useric").html(data);
					    }
				  });
		...
		function refresh() {
			$("#checkCode").attr(
					"src",
					"${pageContext.request.contextPath }/AdminServlet?method=checkCode&"
							+ Math.random());
		}
	</script>
